...
namespace RulesEngineEditor.Pages
{
    partial class RulesEngineEditorPage : ComponentBase
    {
        ...
        private bool ShowDesigner { get; set; }
        private bool ShowDesignerAndJson { get; set; } = true;
        ...
        private void WorkflowJSONChange()
        {
            ...
            try
            {
                ...
                //else
                //{
                //    Mapper.Map<List<WorkflowData>>(WorkflowService.Workflows, workflows);
                //}
